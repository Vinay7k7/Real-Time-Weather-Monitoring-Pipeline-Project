""" This code is designed to work with api and kafka topic in same time 
        Frame using threading concept and which creates real world 
        Data incoming Style ...
        But if you wan tto use the normal way then please
        Look into the '  Api_To_Kafka_With_Pyspark.py '
        In this above code i have used Pyspark 
        But In this Code I haven't. please Mind that !!!
...
# This are the required packages and their dependencies !
import json
import time
...
API_KEY = "70fb0a757c2bfa230e8f00cce4e655b"
